...
<script>
	...
	//匿名函数自调用加载省份信息
	(function(){
		ajax("get","proServlet2",null,function(data){
			eval("var proArray="+data);
			for(var i=0;i<proArray.length;i++){
				var newOpt=document.createElement("option");
				newOpt.value=proArray[i].provinceId;
				newOpt.innerHTML=proArray[i].provinceName;
				pro.appendChild(newOpt);
			}
		});
	})()
